      ...
      <div className="login-wrap">
        ...
        <div className="login-split">
          <div className="login-left">
            <div className="login-eyebrow">Sistema de compras técnicas</div>
            <div className="login-logo-row">
              <img src="/PL.png" alt="Parana Logística" className="login-logo-img" />
            </div>
            <div className="login-title">COMPRAS<span>TÉCNICAS</span></div>
            <div className="login-line" />
            <div className="login-sub">Parana Logística · Requisiciones, tracker de OC y gestión de proveedores.</div>
          </div>
          <div className="login-right">
            <div className="login-card">
              ...
              <div className="login-foot">Parana Logística · Compras Técnicas · Confidencial</div>
            </div>
          </div>
        </div>
      </div>
